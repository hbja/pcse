...
class OpenMeteoWeatherDataProvider(WeatherDataProvider):
        ...
        for attempt in range(6):
            try:
                ...
                if response.status_code == 429:
                    ...
                    wait_time = int(retry_after) if retry_after else backoff * (2 ** attempt)
    ...
    def _get_url(self, previous_runs=False):
        """Constructs the URL for the OpenMeteo API."""
    ...
    def _get_url(self, previous_runs: bool = False) -> str:
        ...
        elif self.model in self.dict_forecast_models and self.is_forecast is True and previous_runs is True:
